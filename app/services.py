    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a nutritionist and chef who creates meals for specific dietary needs. You MUST include any requested ingredients in your recipes. Always respond with valid JSON only."
                },
...
def _build_dietary_requirements_text(
    ...
    # Give highest priority to ingredients
    ...
    # Add an additional note at the end to reinforce the ingredients requirement
    if include_ingredients and len(include_ingredients) > 0:
        requirements.append("IMPORTANT: The recipe MUST include ALL the required ingredients listed above.")
